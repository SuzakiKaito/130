      ...
      <div>
        <div className={styles.content}>
          ...
          <div className={styles.timerContent}>
            ...
            <svg width="280" height="1280" viewBox="0 0 100 100" className={styles.progressCircle}>
              <circle
                cx="280"
                cy="280"
                r="45"
              ...
              <circle
                ...
                strokeWidth="10"
                fill="none"
                strokeDasharray="282.6" // 円周（2 * Math.PI * 半径）
                strokeDashoffset={282.6 - (progress / 100) * 282.6} // プログレスに基づいて調整
