...
export default function timer(){
  ...
  const [starColor, setStarsColor] = useState("gray"); // 星の色を変更するための状態
  ...
  }, [isActive, minutes, seconds, isOneMinuteCycle, oneMinuteCycleCount]);
  const handleStart = () => {
    setIsActive(true);
  };
  const handleStop = () => {
      ...
      <div>
        <div className={styles.content}>
          ...
          <div className={styles.stars}>
            <figure><img src="/images/star.svg" alt="星" style={{ filter: starColor === "yellow" ? "brightness(2) hue-rotate(60deg)" : "none" }}/></figure>
