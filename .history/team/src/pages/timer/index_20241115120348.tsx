...
export default function timer(){
  ...
  const [progress, setProgress] = useState(0); // 進行度を管理する状態
    ...
    if (isActive) {
      ...
      const intervalId = setInterval(() => {
        ...
        // 分が0より大きく秒が0の場合、分を1減らし、秒を59にリセット
          ...
          // タイマーの進行度を更新（全体の割合を計算）
          const totalSeconds = 1 * 60; // 初期設定が1分の場合
          const elapsedSeconds = (1 - minutes) * 60 + (60 - seconds);
    ...
    <>
      <div>
        <div className={styles.content}>
          ...
          <div className={styles.timerContent} style={{
        background: `conic-gradient(#85ABD3 ${progress}%, transparent 0)`
      }}>
