...
export default function timer(){
  ...
  const totalTime = isOneMinuteCycle ? 60 : 30; // 現在のサイクルの秒数
  const timeLeft = minutes * 60 + seconds;
  const progress = ((totalTime - timeLeft) / totalTime) * 100; // 残り時間の割合
      ...
      <div>
        <div className={styles.content}>
          ...
          <div className={styles.timerContent} style={{
              background: `conic-gradient(#ffc107 ${progress}%, rgba(255, 255, 255, 0.2) ${progress}%)`
            }}>
