...
export default function timer(){
  ...
  const [isOneMinuteCycle, setIsOneMinuteCycle] = useState<boolean>(true); // trueなら1分、falseなら30秒
  const [oneMinuteCount, setOneMinuteCount] = useState<number>(0); // 1分タイマーの完了回数
        ...
        <footer className={styles.footerContent}>
          ...
          <div className={styles.footerBox}>
            <div className={styles.footerIcon}>
              <figure className={styles.footerImage}><img src="/images/homeIcon.png" alt="ホームアイコン" /></figure>
              <figure className={styles.footerImage}><img src="/images/timerIcon.png" alt="タイマーアイコン" /></figure>
              <div className={styles.crownIcon}>
                <figure className={styles.footerImage}><img src="/images/crownIcon.png" alt="ランキングアイコン" className={styles.crownIcon}/></figure>
